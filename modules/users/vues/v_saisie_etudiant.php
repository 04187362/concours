...
<head>
        ...
        <title> Saisie Utilisateur - INPTIC</title>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Saisie etudiant </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                ...
                                <form method="post" id="formulaire1" action="" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="niveauetude" class="control-label col-md-4">Niveau Etu*</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="parent" class="control-label col-md-4"> Parent *</label>
                                                        <div class="col-md-8">
                                                            <select id="parent" name="parent" class="form-control selectpicker" data-live-search="true" required>
                                                                <option value="">Selectionner</option>
                                                                <?php 
                                                                        $sql = "SELECT * FROM personne WHERE type_pers='Parent'";
                                                                        $requete4 = AfficherTout($sql);                      
                                                                        //exécution de la requête de sélection et retour des résultats
                                                                        $requete4->execute();
                                                                        //Conservation lignes par ligne des élements retournés
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                var extension = $('#image').val().split('.').pop().toLowerCase();
                    ...
                    $.ajax({
                      url:"index.php?module=users&action=saveEtudiant",
                      method : "POST",
