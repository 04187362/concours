    ...
    <body>
                ...
                <div id="content-container">
                    ...
                    <?php
                          ...
                          if(isset($_GET['cood']) && existanceUsers($table, $colonne, $_GET['cood'])){
                            ...
                            $id_ben = addslashes(htmlspecialchars($_GET['cood']));
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> <span style="font-family:Ravie"> Message envoyés</span> </h3>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Detail des messages envoyés</h3>
                            </div>
                                                ...
                                                <form method="post" action="" id="formulaire1">
                                                    <div class="row">
                                                        <div class="col-xs-8 col-xs-offset-2">
                                                            ...
                                                            <input type="hidden" name="id_ben" id="id_ben" value="<?php echo $id_ben; ?>" required>
                                                            <div class="col-xs-10">
                                                            ...
                                                            foreach ($response as $value) {  ?>
                                                                <li class="mar-btm">
                                                                        ...
                                                                        <div class="media-body pad-hor speech-left">
                                                                            <div class="speech">
                                                                                <a href="#" class="media-heading"><?php echo getChampsUsers($val_recuperer1, $table2, $colonne2, $value['id_ben']).' '.getChampsUsers($val_recuperer2, $table2, $colonne2, $value['id_ben']); ?></a>
        ...
        <script>
         $(document).ready(function(){
          ...
          $('#nouv_message').on('change', function(){
