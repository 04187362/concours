                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des agents</b></h3>
                            </div>
                            <div class="panel-body">
                                <center>
                                    <a href="index.php?module=users&action=saisie_personnel" class="btn btn-success btn-sm" style ="border-radius:5px; margin-left:10px">
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $tablo['droit_acces']; ?></td>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a title="Editer" href="index.php?module=users&action=editer_personnel&cood=<?php echo $tablo['id_pers']; ?>" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"> Modifier</i></a></li>
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-header" style ="background-color:rgb(155,40,20); color:white">
                                                              ...
                                                              <h5 class="modal-title" id="myModalLabel"><center>Suppression d'un agent</center></h5>
                                                            </div>
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=users&action=personnel&parasup=<?php echo $tablo['id_pers'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
                                                                    <div class="form-group"><?php 

                                                                        $requete1 = "SELECT * FROM preinscription WHERE id_personnel=?";
                                                                        $param1 = array($tablo['id_pers']);
                                                                        $nb_preinscription = getNombreLigneGestion($requete1,$param1);

                                                                        if($nb_preinscription > 0){ ?>
                                                                            <p> Cet agent a effectué <b><?php echo $nb_preinscription ?></b> préinscription(s), il est donc impossible de le supprimer.</p>
                                                                            <div class="table-responsive">
                                                                                <table>
                                                                                    <tr>
                                                                   ...
                                                                   <div class="col-md-4">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                      <table>
                                                                        ...
                                                                        <tr>
                                                                          <td style ="padding-right:20px; padding-bottom:10px"><b>Date de naissance :</b></td>
                                                                          <td style ="padding-right:20px" class="pull-right"><?php echo $tablo['date_nais_pers'];?></td> 
                                                                        </tr>
                                                                        <tr>
                                                                          <td style ="padding-right:20px; padding-bottom:10px"><b>Lieu de naissance :</b></td>
                                                                          <td style ="padding-right:20px" class="pull-right"><?php echo $tablo['lieu_nais_pers'];?></td> 
                                                                        </tr>
                                                                        <tr>
                                                                          <td style ="padding-right:20px; padding-bottom:10px"><b>E-mail :</b></td>
                                                                          <td style ="padding-right:20px" class="pull-right label label-mint"><?php echo $tablo['email_pers'];?></td> 
                                                                        </tr>
                                                                        <tr >
