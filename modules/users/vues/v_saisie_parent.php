    ...
    <body>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Saisie parent </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                ...
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="prof_par" class="col-md-4 control-label">Profession</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="prof_par" name="prof_par"  class="form-control" required />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=users&action=parent" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=users&action=saveParent",
                  method : "POST",
