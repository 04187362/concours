                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'un parent</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="prof_par" name="prof_par" value="<?php echo $p['prof_par'] ?>" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-8">
                                                            <input type="hidden" id="type_pers" name="type_pers" value="Parent"  class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
