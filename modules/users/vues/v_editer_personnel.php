                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li> Parent </li>
                                <li class="active"> Editer personnel </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'un agent</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="date" id="date_nais" name="date_nais" value="<?php echo $p['date_nais_pers'] ?>" class="form-control" required />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="prof_par" class="col-md-4 control-label">Lieu naissance</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lieu_nais" name="lieu_nais" value="<?php echo $p['lieu_nais_pers'] ?>" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="email" id="email_pers" name="email_pers" value="<?php echo $p['email_pers'] ?>" class="form-control" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="role" name="role" class="form-control selectpicker" data-live-search="true" required>
                                                                <?php if($p['role']=="Directeur General"){ ?>
                                                                    <option>Directeur General</option>
                                                                    <option>Directeur des Etudes</option>
                                                                    <option>Gestionnaire</option>
                                                                <?php }else if($p['role']=="Directeur des Etudes"){ ?>
                                                                    <option>Directeur des Etudes</option>
                                                                    <option>Gestionnaire</option>
                                                                    <option>Directeur General</option>
                                                                <?php }else{ ?>
                                                    ...
                                                    <div class="col-md-8">
                                                            <input type="hidden" id="type_pers" name="type_pers" value="Personnel"  class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
