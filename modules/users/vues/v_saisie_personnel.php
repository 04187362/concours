    ...
    <body>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li> Enseignant </li>
                                <li class="active">Saisie personnel </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                ...
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="date_nais" class="col-md-4 control-label">Date naiss</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="lieu_nais" class="col-md-4 control-label">Lieu naiss</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="email_pers" name="email_pers"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="conf_password" class="col-md-4 control-label">Conf Passw</label>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="role" class="control-label col-md-4"> Rôle </label>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=users&action=personnel" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=users&action=savePersonnel",
                  method : "POST",
