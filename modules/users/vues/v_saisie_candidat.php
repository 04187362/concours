...
<head>
        ...
        <title> saisie candidat - GESET</title>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Saisie candidat </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                ...
                                <form method="post" id="formulaire1" action="" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="nom_pers" name="nom_pers" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="prenom_pers" name="prenom_pers"  class="form-control" />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="sexe_pers" class="control-label col-md-4"> Sexe </label>
                                                        <div class="col-md-8">
                                                            <select id="sexe_pers" name="sexe_pers" class="form-control selectpicker" data-live-search="true" required>
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="adresse_pers" name="adresse_pers"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" id="tel_pers" name="tel_pers"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="date_nais" class="col-md-4 control-label">Date nais</label>
                                                        <div class="col-md-8">
                                                            <input type="date" id="date_nais" name="date_nais"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="lieu_nais" class="col-md-4 control-label">Lieu nais</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lieu_nais" name="lieu_nais"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="specialite" class="control-label col-md-4"> Spécialité</label>
                                                        <div class="col-md-8">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="niv_etu_univ" class="col-md-4 control-label">Niv etu univ</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="niv_etu_univ" name="niv_etu_univ"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="sexe_pers" name="statut" class="form-control selectpicker" data-live-search="true" required>
                                                                <option value="">Selectionner</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=users&action=candidat" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                if(jQuery.inArray(extension, ['gif','png','jpg','jpeg'])== -1){
                    ...
                    $.ajax({
                      url:"index.php?module=users&action=saveCandidat",
                      method : "POST",
