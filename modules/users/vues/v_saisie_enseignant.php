...
<head>
        ...
        <title> Saisie enseignant - GESET</title>
    ...
    <body>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li> Enseignant </li>
                                <li class="active">Saisie enseignant </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Ajout d'un enseignant</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="email_ens" class="col-md-4 control-label">Email</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="email_ens" name="email_ens"  class="form-control" required />
                                                        </div>
                                                    </div>
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=users&action=saveEnseignant",
                  method : "POST",
