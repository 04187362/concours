...
<head>
        ...
        <title> editer cycle - GESET</title>
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  $id_cycle = htmlspecialchars($_GET['cood']);
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Edition cycle </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'un cycle</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    
                                                <input type="hidden" id="id_cycle" name="id_cycle" value="<?php echo $p['id_cycle'] ?>" class="form-control" required />
                                                    <div class="form-group">
                                                        <label for="lib" class="col-md-4 control-label">Libellé du cycle</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lib_cycle" name="lib_cycle" value="<?php echo $p['lib_cycle'] ?>" placeholder="Libellé"  class="form-control" required />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="frais" class="col-md-4 control-label">Frais du cycle</label>
                                                        <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=parametrage&action=cycle" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=parametrage&action=updateCycle",
                  method : "POST",
