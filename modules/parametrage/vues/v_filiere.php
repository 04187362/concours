                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <center>
                                    <a href="index.php?module=parametrage&action=saisie_filiere" class="btn btn-mint btn-sm" style ="border-radius:5px; margin-left:10px">
                                      ...
                                      <table id="demo-dt-basic" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <center>
                                                  <a href="index.php?module=parametrage&action=editer_filiere&cood=<?php echo $p['id_filiere']; ?>" class="btn btn-primary btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a>
