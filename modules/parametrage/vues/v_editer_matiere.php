    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i><span style="font-family:Times New Roman"> Parametrage </sapn></h3>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li> <a href="#"> Accueil </a> </li>
                                <li class="active">Edition matière </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                ...
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    ...
                                                    <input type="hidden" id="id_m" name="id_m" value="<?php echo $p['id_matiere'] ?>" class="form-control" required />
                                                    
                                                    <div class="form-group">
                                                        <label for="lib" class="col-md-4 control-label">Libellé</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lib" name="lib" value="<?php echo $p['lib_matiere'] ?>" placeholder="Libellé"  class="form-control" required />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=parametrage&action=matiere" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=parametrage&action=updateMatiere",
                  method : "POST",
