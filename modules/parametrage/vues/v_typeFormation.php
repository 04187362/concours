...
<head>
        ...
        <title>Type Formation - GESET</title>
            ...
            <header id="navbar">
                ...
                <?php 
                  ...
                  if(isset($_POST['supprimer'])){
                    ...
                    $id_type = htmlentities(htmlspecialchars($_GET['parasup']));

                    $requete = "SELECT * FROM type_formation WHERE id_typeformation = ? ";
                    ...
                    if(isset($_GET['parasup']) && existanceParametrage($requete, $param)){
                        ...
                        $typeformation->supprimerTypeFormation();
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Type formation </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des types de formation</b></h3>
                            </div>
                            <div class="panel-body">
                              <center>
                                    <a href="index.php?module=parametrage&action=saisie_typeForConcours" class="btn btn-success btn-sm" style ="border-radius:5px; margin-left:10px">
                                  ...
                                  <div class="table-responsive">
                                      <table id="demo-dt-basic" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  <td class="text-center"><?php echo $p['id_typeformation']; ?></td>
                                                  <td class="text-center"><?php echo $p['lib_typeformation']; ?></td>
                                                  <td class="text-center"><?php echo $p['frais']; ?> FCFA</td>
                                                  <td class="text-center">
                                              
                                                      <center>
                                                        <a href="index.php?module=parametrage&action=editer_typeForConcours&cood=<?php echo $p['id_typeformation']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a> 

                                                        <a  class="btn btn-danger btn-xs" title='Supprimer' data-toggle="modal" data-target=".<?php echo $p['id_typeformation'];?>sbs-example-modal-lg"><i class="glyphicon glyphicon-trash"></i></a>
                                                        <!-- modale de suppression -->
                                                          <div class="modal fade <?php echo $p['id_typeformation'];?>sbs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                                              <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-body">
                                                                    <form  method="POST" action="index.php?module=parametrage&action=typeFormation&&parasup=<?php echo $p['id_typeformation'];?>" class="form-horizontal form-label-left input_mask">
                                                                      <center>
                                                                          <div class="form-group">
                                                                            <?php 

                                                                              $requete1 = "SELECT count(*) FROM payement WHERE id_typeformation=?";
                                                                              $param1 = array($p['id_typeformation']);
                                                                              ...
                                                                              if($nb_typeformation > 0){ ?>
                                                                                  ...
                                                                                  <p> Ce type de formation contient <b><?php echo $nb_typeformation ?></b> payement(s), il est donc impossible de le supprimer.</p>
                                                                                      <div class="table-responsive">
                                                                                              <table>
                                                                                                    <tr>
                                                                                                        <td><b>Identifiant : </b></td><td><?php echo $p['id_typeformation']; ?></td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td><b>Libellé : </b></td><td><?php echo $p['lib_typeformation']; ?></td>
                                                                                                    </tr>
                                                                                        </table><br/>
