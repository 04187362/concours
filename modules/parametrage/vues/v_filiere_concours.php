        ...
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php 
                  ...
                  $id_filiere=htmlentities(htmlspecialchars($_GET['parasup']));

                    $requete = "SELECT * FROM filiere WHERE id_filiere = ? ";
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des Filières</b></h3>
                            </div>
                            <div class="panel-body">

                                <center>
                                    <a href="index.php?module=parametrage&action=saisie_filiereConcours" class="btn btn-success btn-sm" style ="border-radius:5px; margin-left:10px">
                                  ...
                                  <div class="table-responsive">
                                      <table id="demo-dt-basic" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  <td class="text-center"><?php echo $p['id_filiere']; ?></td>
                                                  <td class="text-center"><?php echo $p['lib_filiere']; ?></td>
                                                  <td class="text-center"><?php echo $p['abreviation']; ?></td>
                                                  <td class="text-center">
                                              
                                                <center>
                                                  <a href="index.php?module=parametrage&action=editer_filiereConcours&cood=<?php echo $p['id_filiere']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a>

                                                  <a  class="btn btn-danger btn-xs" title='Supprimer' data-toggle="modal" data-target=".<?php echo $p['id_filiere'];?>sbs-example-modal-lg"><i class="glyphicon glyphicon-trash"></i></a>
                                                  <!-- modale de suppression -->
                                                    <div class="modal fade <?php echo $p['id_filiere'];?>sbs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=parametrage&action=filiere&parasup=<?php echo $p['id_filiere'];?>" class="form-horizontal form-label-left input_mask">
                                                                <?php


                                                                        $requete1 = "SELECT count(*) as effectif FROM candidat WHERE id_filiere=?";
                                                                        $requete2 = "SELECT count(*) as effectif FROM programme_concours WHERE id_filiere=?";
                                            
                                                                        $param1 = array($p['id_filiere']);

                                                                        $nb_candidat= getNombreLigneGestion($requete1,$param1);
                                                                        $nb_programme= getNombreLigneGestion($requete2,$param1);
                                                                

                                                                        if($nb_candidat> 0){ ?>
                                                                              
                                                                            <p> Cette filière contient <b><?php echo $nb_candidat ?></b> Candidat(s), il est donc impossible de la supprimer.</p>
                                                                                  <center>
                                                                                      <div class="form-group">
                                                                                        <div> 
                                                                                              <table>
                                                                                                  <tr>
                                                                                                      <td><b>Identifiant : </b></td><td><?php echo $p['id_filiere']; ?></td>
                                                                                                  </tr>
                                                                                                  <tr>
                                                                                                      <td><b>Libellé : </b></td><td><?php echo $p['lib_filiere']; ?></td>
                                                                                                  </tr>
                                                                                              </table><br/>
