                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <center>
                                    <a href="index.php?module=parametrage&action=saisie_paysConcours" class="btn btn-success btn-sm" style ="border-radius:5px; margin-left:10px">
                                      ...
                                      <table id="demo-dt-basic" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <center>
                                                  <a href="index.php?module=parametrage&action=editer_paysConcours&cood=<?php echo $p['code_pays']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a> 
