                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des unités d'enseignement </b></h3>
                            </div>
                            <div class="panel-body">

                                <center>
                                    <a href="index.php?module=parametrage&action=saisie_uniteEnseignement" class="btn btn-mint btn-sm" style ="border-radius:5px; margin-left:10px">
                                      ...
                                      <table id="demo-dt-basic" class="table table-striped table-bordered">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td><?php echo $p['lib_ue']; ?></td>
                                                  <td class="text-center"><?php echo $p['abreviation']; ?></td>
                                                  <td class="text-center">
                                              
                                                <center>
                                                  <a href="index.php?module=parametrage&action=editer_uniteEnseignement&cood=<?php echo $p['id_ue']; ?>" class="btn btn-primary btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a>
                                                  <a  class="btn btn-danger btn-xs" title='Supprimer' data-toggle="modal" data-target=".<?php echo $p['id_ue'];?>sbs-example-modal-lg"><i class="glyphicon glyphicon-trash"></i></a>
