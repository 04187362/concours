...
<head>
        ...
        <title> Selectionner année - INPTIC</title>
    ...
    <body>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Selectionner année </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    <div class="form-group">
                                                        <label for="annee" class="control-label col-md-4"> Sectionner année </label>
                                                        <div class="col-md-8">
                                                            <select id="annee" name="annee" class="form-control selectpicker" data-live-search="true" required>
                                                                <option value=""><?php echo getChampsParametrage($requests, $paramaters); ?></option>
                                                                <?php 
      ...
      $(document).ready(function(){
          ...
          function actualiser_anneeAcademique(){
            $.ajax({

                url: "index.php?module=parametrage&action=actualiserAnneAcademique",
                method : "POST",
                data:new FormData(),
                contentType : false,
                processData : false,
          ...
          $('#annee').on('change', function(){
            ...
            var id_annee = $(this).val();
            if(id_annee){

              $.post("index.php?module=parametrage&action=miseAjourAnneeAcademique",
              {id_annee:id_annee},
                function(data){
                  /*$('#message').modal('show');
                    $('#contenu_message').html(data);*/
                    actualiser_anneeAcademique();
                }
              );
              return false;
            }
