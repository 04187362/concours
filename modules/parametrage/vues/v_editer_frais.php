...
<head>
        ...
        <title> Editer frais - INPTIC</title>
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  $id_frais =htmlentities(htmlspecialchars($_GET['cood']));
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'un frais</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    
                                                <input type="hidden" id="id_frais" name="id_frais" value="<?php echo $p['id_frait'] ?>" class="form-control" required />
                                                    <div class="form-group">
                                                        <label for="montant" class="col-md-4 control-label">Montant</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="montant" name="montant" value="<?php echo $p['montant'] ?>" placeholder="Libellé"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=parametrage&action=frait" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=parametrage&action=updateFrait",
                  method : "POST",
