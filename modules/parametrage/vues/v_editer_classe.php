            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> Classe </h3>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li> <a href="#"> Accueil </a> </li>
                                <li class="active">Edition classe </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="id_c" name="id_c" value="<?php echo $p['id_classe'] ?>" class="form-control" required />
                                                    <div class="form-group">
                                                        <label for="lib" class="col-md-4 control-label">Libellé</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lib" name="lib" value="<?php echo $p['lib_classe'] ?>" placeholder="Libellé"  class="form-control" required />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="pri" class="col-md-4 control-label">Prix</label>
                                                        <div class="col-md-8">
                                                            <input type="number" id="pri" name="pri" value="<?php echo $p['prix'] ?>" placeholder="Prix" class="form-control"  required />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=parametrage&action=classe" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
