                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                              <center>
                                    <a href="index.php?module=parametrage&action=saisie_fraisConcours" class="btn btn-mint btn-sm" style ="border-radius:5px; margin-left:10px">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td class="text-center">
                                                      ...
                                                      <center>
                                                        <a href="index.php?module=parametrage&action=editer_fraisConcours&cood=<?php echo $p['id_frait']; ?>" class="btn btn-primary btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a> 
                                                              ...
                                                              <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                  ...
                                                                  <div class="modal-body">
                                                                    <form  method="POST" action="index.php?module=parametrage&action=frais_concours&&parasup=<?php echo $p['id_frait'];?>" class="form-horizontal form-label-left input_mask">
                                                                      <center>
