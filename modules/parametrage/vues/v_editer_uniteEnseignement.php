...
<head>
        ...
        <title> editer filière - GESET</title>
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  $id_ue= htmlentities(htmlspecialchars($_GET['cood']));
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Edition unité d'enseignement </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'une unité d'enseignement</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    
                                                <input type="hidden" id="id_ue" name="id_ue" value="<?php echo $p['id_ue'] ?>" class="form-control" required />
                                                   
                                                    <div class="form-group">
                                                        <label for="lib" class="col-md-4 control-label">Libellé *</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lib_ue" name="lib_ue" value="<?php echo $p['lib_ue'] ?>" placeholder="Libellé"  class="form-control" required />
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=parametrage&action=uniteEnseignement" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=parametrage&action=updateUniteEnseignement",
                  method : "POST",
