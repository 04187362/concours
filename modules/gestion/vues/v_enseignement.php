                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des enseignements</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql ="SELECT count(*) as effectif, n.id_niveauetude, lib_niveauetude 
                                                        FROM enseigner e, niveau_etude n
                                            ...
                                            <tr>
                                                <td class="text-center"><?php echo $tablo['id_niveauetude']; ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_enseignement&cood=<?php echo $tablo['id_niveauetude']; ?>" class="btn btn-warning  btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
