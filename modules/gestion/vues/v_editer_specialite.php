...
<head>
        ...
        <title> Editer spécialité - GESET</title>
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  $id_spe = htmlentities(htmlspecialchars($_GET['cood']));
                  $requete = "SELECT * FROM specialite WHERE id_spe=?";
                  $param = array($id_spe);
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'une spécialité</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    
                                                    <input type="hidden" id="id_specialite" name="id_specialite" value="<?php echo $p['id_spe'] ?>" class="form-control" required />
                                                    <div class="form-group">
                                                        <label for="lib_specialite" class="col-md-4 control-label">Libellé</label>
                                                        <div class="col-md-8">
                                                            <input type="text" id="lib_specialite" name="lib_specialite" value="<?php echo $p['lib_spe'] ?>" placeholder="Libellé"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <?php 
                                                                ...
                                                                $param2 = array($p['id_filiere']);
                                                                echo '<option value="'.$p['id_filiere'].'">'.getChampsParametrage($requete2, $param2).'</option>'; 
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=specialite" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=updateSpecialite",
                  method : "POST",
