...
<head>
        ...
        <title>Emploi du temps - GESET</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> <span style="font-family:Times New Roman"> Emploi du temps </span> </h3>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Emploi du temps de 
                                    <span class="text-info">
                                        <?php 
                                            $requete = "SELECT lib_niveauetude FROM niveau_etude WHERE id_niveauetude=?";
                                            $param = array($classe_etudiant);
                                            echo getChampsParametrage($requete,$param); 
                                        ?>
                                    </span>
                                </h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="text-center">
                                    <a class="btn btn-default bn-xs pull-right" href="index.php?module=users&action=imprimer_emploiTemps&cood=<?php echo $classe_etudiant; ?>"><i class="fa fa-print"></i> Imprimer</a>
                                </div> 
                            </div>
                        </div>
