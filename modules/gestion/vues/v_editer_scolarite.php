...
<head>
        ...
        <title> Saisie frais scolarité - GESET</title>
    ...
    <body>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Editer frais scolarité </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edtion d'un frais de scolarité</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="frais" name="frais" class="form-control selectpicker" data-live-search="true" required>
                                                                
                                                                <?php 

                                                                    // Recuperation de l'identifiant du cycle
                                                                    $requete5 = "SELECT montant FROM frait WHERE id_frait =?";
                                                                    $param5 = array($p['id_frais']);

                                                                    echo '<option value="'.$p['id_frais'].'">'.getChampsParametrage($requete5, $param5).'</option>';
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=detail_scolarite&cood=<?php echo $id_etudiant; ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=updateScolarite",
                  method : "POST",
