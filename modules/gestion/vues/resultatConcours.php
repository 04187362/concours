                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Resultats des examens</b></h3>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="bg-gray" style=" padding:10px; border-radius:10px">
                                    <p style"font-family:Times New Roman; font-size:20px">Les etudiants dont les noms et prénoms suivent, sont declarés admis au concours d'entrée à l'Institut National de la Poste, des Technologies de l'Information et de la Communication session <?php echo date('Y'); ?> au benefice d'une bourse d'etude au titre de l'année académique <?php echo $libelle_anneeAc; ?></p>
                                </div>
                                <hr>
