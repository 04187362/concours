            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> <span style="font-family:Times New Roman"> Concours </span> </h3>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des cursus</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT id_etu, count(id_etu) as effectif FROM cursus GROUP BY id_etu";
