                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des programmes</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql ="SELECT count(*) as effectif, n.id_niveauetude, lib_niveauetude FROM programme p, niveau_etude n
                                                        WHERE p.id_niveauetude=n.id_niveauetude
                                                        AND id_annee=?
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_programme&cood=<?php echo $tablo['id_niveauetude']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
