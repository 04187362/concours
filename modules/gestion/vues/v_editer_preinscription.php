...
<head>
        ...
        <title> Saisie preinscription - GESET</title>
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <?php
                        ...
                        $requete1 = "SELECT * FROM preinscription WHERE id_pre=?";
                        $param1 = array($id_pre);
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Ajout préinscription </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'une préinscription</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    <input type="hidden" id="id_pre" name="id_pre" value="<?php echo $p['id_pre'] ?>" class="form-control" required />
                                                    <div class="form-group">
                                                        <label for="candidat" class="control-label col-md-4"> Candidat </label>
                                                        <div class="col-md-8">
                                                            <select id="candidat" name="candidat" class="form-control selectpicker" data-live-search="true" class="form-control jour" required>
                                                                <?php 
                                                                    ...
                                                                    $sql = "SELECT * FROM personne WHERE type_pers='Candidat'";
                                                    ...
                                                    <div class="form-group">
                                                        <label for="frais" class="control-label col-md-4"> Frais </label>
                                                        <div class="col-md-8">
                                                            <select id="frais" name="frais" class="form-control selectpicker" data-live-search="true" class="form-control jour" required>
                                                                <?php

                                                                    // Recuperation de l'identifiant de la  filiere de l'etudiant
                                                                    $requete5 = "SELECT montant FROM frait WHERE id_frait =?";
                                                                    $param5 = array($p['id_typeformation']);

                                                                    echo '<option value="'.$p['id_frait'].'">'.getChampsParametrage($requete5, $param5).' FCFA</option>';

                                                                    $sql = "SELECT * FROM frait ";
                                                                    $requete4 = AfficherTout($sql);                      
                                                                    //exécution de la requête de sélection et retour des résultats
                                                                    $requete4->execute();
                                                                    //Conservation lignes par ligne des élements retournés
                                                                    while($tablo=$requete4->fetch()){                      
                                                                    echo  '<option value ="'.$tablo['id_farit'].'">'.$tablo['montant'].' FCFA</option>';
                                                                } ?>     
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=preinscription" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=updatePreinscription",
                  method : "POST",
