                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des candidats admis au concours</b></h3>
                            </div>
                                
                            <div class="panel-body">
                                <div class="bg-gray" style=" padding:10px; border-radius:10px">
                                    <p style"font-family:Forte; font-size:20px">Les etudiants dont les noms et prénoms suivent, sont declarés admis au concours d'entrée à l'Institut GESET session <?php echo date('Y'); ?> au benefice d'une bourse d'etude au titre de l'année académique <?php echo $libelle_anneeAc; ?></p>
                                </div>
                                <hr>
                                    ...
                                    <tbody>
                                        <?php 
                                                ...
                                                while($tablo=$requete->fetch()){
                                                        ...
                                                        //Recuperation du rang de l'etudian
                        ...
                        <div> 
                            <span style="float : right"><a href="index.php?module=users&action=imprimer_listeAdmisConcours&cood=<?php echo $id_filiere; ?>" class="btn btn-default btn-xs"><i class="fa fa-print"></i> Imprimer</a></span> 
                        </div> 
                    </div>
                    <!--===================================================-->
                    <!--End page content-->
