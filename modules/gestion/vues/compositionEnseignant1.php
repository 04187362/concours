    ...
    <body>
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Liste de compositions</legend>
                                            </div>
                                            <div class="row">
      ...
      $(document).ready(function(){
          ...
          $('#classe').on('change', function(){
            ...
            var action = "classe_details";
            if(id_classe){

              $.post("index.php?module=gestion&action=ajaxEmargement",
              {id_classe:id_classe, id_ens:id_ens, action:action},
                function(data){
                  $('#matiere').html(data);
                }
              );
          ...
          $('#matiere').on('change', function(){
            ...
            var action = "matiere_enseignant";

            if(id_matiere){
              $.post("index.php?module=gestion&action=ajaxGestion",
              {id_matiere:id_matiere, id_ens:id_ens, id_classe:id_classe, action:action},
                function(data){
                  $('#details').html(data);
                }
              );
