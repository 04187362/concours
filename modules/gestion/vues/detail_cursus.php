            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <?php 
                        ...
                        // Verifiant l'existance de l'identifiant du candidat.
                        $id_candidat = htmlentities(htmlspecialchars($_GET['cood']));

                        $requete2 = "SELECT * FROM payement WHERE id_candidat = ?";
                        ...
                        if(isset($_GET['cood']) && existanceGestion($requete2,$param2)){
                          ...
                          $param4 = array($id_candidat);

                          $nom_pers= getChampsUsers($requete3,$param3);
                          $prenom_pers= getChampsUsers($requete4,$param4);
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Detail cursus </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des cursus de <b class="text-primary"><?php echo $nom_pers.' '.$prenom_pers ; ?></b></h3>
                            </div>
                            <div class="panel-body">
                                <center>
                                    <a href="index.php?module=gestion&action=saisie_composition" class="btn btn-success btn-sm" style ="border-radius:5px; margin-left:10px">
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Année Acad</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM payement p, filiere f, matiere m, annee_academique a 
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=editer_composition&cood=<?php echo $tablo['id_paye']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a> 
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-header" style ="background-color:rgb(155,40,20); color:white">
                                                              ...
                                                              <h4 class="modal-title" id="myModalLabel"><center>Supprimer un cursus</center></h4>
                                                            </div>
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=gestion&action=cursus&cood=<?php echo $id_candidat ?>&parasup=<?php echo $tablo['id_paye'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
                                                                    <div class="form-group">
                                                                      <div>
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    <td><b>Annee academique : </b></td><td><?php echo $tablo['lib_annee']; ?></td>
                                                                                </tr>
                                                                            </table><br>
