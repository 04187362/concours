...
<head>
        ...
        <title> Saisie emploi temps - GESET</title>
    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i><sapn style="font-family:Times New Roman">Parametrage </span></h3>
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Ajout d'un emploi du temps</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="lundi" name="lundi" class="form-control jour">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="mardi" name="mardi" class="form-control jour">
                                                                <option>Selectionner</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="mercredi" name="mercredi" class="form-control jour">
                                                                <option>Selectionner</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="jeudi" name="jeudi" class="form-control jour">
                                                                <option>Selectionner</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="vendredi" name="vendredi" class="form-control jour">
                                                                <option>Selectionner</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="samedi" name="samedi" class="form-control jour">
                                                                <option>Selectionner</option>
                                                            </select>
                                                        </div>
                                                    </div>
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=saveEmploiTemps",
                  method : "POST",
