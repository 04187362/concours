...
<head>
        ...
        <title> edition inscription - GESET</title>
        ...
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  $id_ins = htmlentities(htmlspecialchars($_GET['cood']));
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Edition inscription </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'une inscription</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3">
                                                    <input type="hidden" id="id_ins" name="id_ins" value="<?php echo $p['id_ins'] ?>" class="form-control" required />
                                                    <!-- recuperation de l'identifant de l'année academique via la session -->
                                                    <div class="form-group">
                                                        <div >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="etudiant" name="etudiant" class="form-control selectpicker" data-live-search="true" class="form-control jour" required>
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    echo '<option value="'.$p['id_etu'].'">'.getChampsParametrage($val_recuperer3, $table3, $colonne3, $p['id_etu']).' '.getChampsParametrage($val_recuperer4, $table3, $colonne3, $p['id_etu']).'</option>'; 
                                                                        ...
                                                                        $colonne4 ="type_pers";
                                                                        $value4 = "Etudiant";
                                                                        $resultat3 = afficherTableGestion($table3, $colonne4,  $value4); 
                                                                        foreach($resultat3 as $tablo){                         
                                                    ...
                                                    <div>
                                                            <input type="hidden" id="gestion" name="gestion" value="inscription"  class="form-control" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=inscription" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
