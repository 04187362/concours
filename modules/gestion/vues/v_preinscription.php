                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <center>
                                    <a href="index.php?module=gestion&action=saisie_preinscription" class="btn btn-mint btn-sm" style ="border-radius:5px; margin-left:10px">
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        <thead>
                                            <tr class="bg-gray">
                                                ...
                                                <th class="text-center">Nombre de candidats</th>
                                                <th class="text-center"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $sql ="SELECT count(*) as effectif, f.id_filiere, lib_filiere FROM preinscription pr, personne p, filiere f
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_preinscription&cood=<?php echo $tablo['id_filiere']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
