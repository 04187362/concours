                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT n.id_niveauetude, lib_niveauetude, count(*) as effectif FROM emargement e, niveau_etude n
                                                            WHERE e.id_niveauetude = n.id_niveauetude 
                                                            AND id_ens = '$id_personne'
                                                            GROUP BY n.id_niveauetude, lib_niveauetude";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=emargement_enseignant2&cood=<?php echo $tablo['id_niveauetude']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
