                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Payement des frais d'inscriptions</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="nom_pers" class="col-md-4 control-label">Date naissance</label>
                                                        <div class="col-md-8">
                                                            <input type="date" id="date_nais_etu" name="date_nais_etu" class="form-control" required />
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="prenom_pers" class="col-md-4 control-label">Montant à payer</label>
                                                        <div class="col-md-8">
