...
<head>
        ...
        <title>Frais scolarité - GESET</title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des etudiants qui ont payé leur frais de scolarité</b></h3>
                            </div>
                            <div class="panel-body">
                                <center>
                                    <a href="index.php?module=gestion&action=saisie_scolarite" class="btn btn-mint btn-sm" style ="border-radius:5px; margin-left:10px">
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        <thead>
                                            <tr class="bg-gray">
                                                ...
                                                <th class="text-center">Nombre de payements</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sql = "SELECT id_pers,nom_pers, prenom_pers, count(*) as effectif 
                                                        FROM payement p, personne pe
                                                        WHERE pe.id_pers = p.id_etu
                                                        AND type_payement = 'Scolarite'
                                                        AND p.id_annee = ? 
                                                        GROUP BY id_pers";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_scolarite&cood=<?php echo $tablo['id_pers']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=gestion&action=cursus&parasup=<?php echo $tablo['id_pers'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
