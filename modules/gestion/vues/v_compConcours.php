...
<head>
        ...
        <title>composition concours - GESET</title>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> composition concours</li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        <thead>
                                            <tr class="bg-gray">
                                                ...
                                                <th class="text-center">Nombre de composition</th>
                                                <th></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            $sql = "SELECT id_candidat, nom_pers, prenom_pers, count(id_candidat) as effectif 
                                            		FROM composer_concours c, personne p 
                                               ...
                                               ?>
                                            <tr>
                                                <td class="text-center"><?php echo $tablo['id_candidat']; ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_compConcours&cood=<?php echo $tablo['id_candidat']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                    <a  class="btn btn-danger btn-xs" title='Supprimer' data-toggle="modal" data-target=".<?php echo $tablo['id_candidat'];?>sbs-example-modal-lg"><i class="glyphicon glyphicon-trash"></i></a>
                                                    <div class="modal fade <?php echo $tablo['id_candidat'];?>sbs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=gestion&action=compConcours&parasup=<?php echo $tablo['id_candidat'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
                                                                    <div class="form-group">
                                                                      <div>
                                                                        <p><b>Attention ! Vous allez supprimer tous les examens et devoirs effectué par </b></p>
                                                                            <p><b><?php echo $tablo['prenom_pers'].' '.$tablo['nom_pers']; ?> </b></p>
