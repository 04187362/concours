                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des filières</h3>
                            </div>
                                    ...
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        <thead>
                                            <tr class="bg-gray">
                                                ...
                                                <th class="text-center">Nombre de spécialité</th>
                                                <th class="text-center"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                $sql ="SELECT count(*) as effectif, f.id_filiere, lib_filiere FROM specialite s, filiere f
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_specialite&cood=<?php echo $tablo['id_filiere']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i> Détail</a> 
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
