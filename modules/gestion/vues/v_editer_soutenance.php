    ...
    <body>
                                ...
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="cycle" class="control-label col-md-4"> Cycle </label>
                                                        <div class="col-md-8">
                                                            <select id="cycle" name="cycle" class="form-control selectpicker" data-live-search="true" required>
                                                                
                                                                <?php 

                                                                    // Recuperation de l'identifiant du cycle
                                                                    $requete5 = "SELECT lib_cycle FROM cycle WHERE id_cycle =?";
                                                                    $param5 = array($p['id_cycle']);

                                                                    echo '<option value="'.$p['id_cycle'].'">'.getChampsParametrage($requete5, $param5).'</option>';
                                                                        ...
                                                                        //Conservation lignes par ligne des élements retournés
                                                                        while($tablo=$requete->fetch()){                        
                                                                            echo  '<option value ="'.$tablo['id_cycle'].'">'.$tablo['lib_cycle'].'  ('.$tablo['frais'].')</option>';
                                                                } ?>     
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=detail_soutenance&cood=<?php echo $id_etudiant; ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=updateSoutenance",
                  method : "POST",
