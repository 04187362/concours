    ...
    <body>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> <span style="font-family:Ravie"> Emploi du temps </span> </h3>
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Emploi du temps</h3>
                            </div>
      ...
      $(document).ready(function(){
          ...
          $('#classe').on('change', function(){
            ...
            var action = "classe_enseignant";
            if(id_classe){

              $.post("index.php?module=gestion&action=ajaxEmplois",
              {id_classe:id_classe, enseignant:enseignant, action:action},
                function(data){
                  $('#emploi').html(data);
                }
              );
