...
<head>
        ...
        <title> Saisie composition - INPTIC</title>
    ...
    <body>
                                ...
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="ue" name="ue" class="form-control" data-live-search="true" required>
                                                                <option value="">Selectionnner</option>   
                                                            </select>
                                                            <!--===================================================-->
                                                        </div>
                                                ...
                                                <div class="col-md-6"> 
                                                    ...
                                                    <div class="form-group">
                                                        <label for="semestre" class="control-label col-md-4"> Semestre *</label>
                                                        <div class="col-md-8">
                                                            <select id="semestre" name="semestre" class="form-control selectpicker" data-live-search="true" required>
                                                                <option value="">Selectionner</option>     
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=composition" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          // On recupere uniquement les etudiants d'un niveau d'etude selectionné
          ...
          // On recupere uniquement les unité d'enseignement du niveau d'etude selectionné
          $('#niveauetude').on('change', function(){
            var id_niveauetude = $(this).val();
          ...
          $('#ue').on('change', function(){
            ...
            var action = "remplir_matiereEtab";
            if(id_ue){
