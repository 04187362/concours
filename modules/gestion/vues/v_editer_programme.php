...
<head>
        ...
        <title> editer programme - GESET</title>
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  $id_pro = htmlentities(htmlspecialchars($_GET['cood']));
                  $requete = "SELECT * FROM programme WHERE id_pro=?";
                  $param = array($id_pro);
                  if(isset($_GET['cood']) && existanceGestion($requete,$param)){
                    // On recupère le programme à partir de l'identifiant'
                    $p = selection_condition($requete,$param);
                    //On recupere le niveau d'etude au quel la matière a été programmé
                    $requete1 = "SELECT id_niveauetude FROM programme WHERE id_pro=?";
                    $id_niveauetude = getChampsGestion($requete1,$param);
                    //On recupere la filière du niveau d'etude de la matière programmée
                    $requete2 = "SELECT id_filiere FROM niveau_etude WHERE id_niveauetude=?";
                    $param2 = array($id_niveauetude);
                    $id_filiere = getChampsParametrage($requete2,$param2);
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Edition programme </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'un programme</legend>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    
                                                    <input type="hidden" id="id_pro" name="id_pro" value="<?php echo $p['id_pro'] ?>" class="form-control" required />
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="filiere" name="filiere" class="form-control selectpicker" data-live-search="true" required>
                                                                <?php 
                                                                    ...
                                                                    echo '<option value="'.$id_filiere.'">'.getChampsParametrage($requete3,$param3).'</option>';
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="ue" name="ue" class="form-control selectpicker" data-live-search="true" required>                         
                                                                <?php 
                                                                    ...
                                                                    echo '<option value="'.$p['id_ue'].'">'.getChampsParametrage($requete2,$param2).'</option>'; 
                                                                      $sql2 = "SELECT  * FROM unite_enseignement";
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select id="matiere" name="matiere" class="form-control selectpicker" data-live-search="true" required>
                                                                <?php 
                                                                    $requete3 = "SELECT lib_matiere FROM matiere WHERE id_matiere=?";
                                                                    $param3 = array($p['id_matiere']);
                                                                    echo '<option value="'.$p['id_matiere'].'">'.getChampsParametrage($requete3,$param3).'</option>';
                                                    ...
                                                    <div class="form-group">
                                                        <label for="coef" class="col-md-4 control-label">Coefficient *</label>
                                                        <div class="col-md-8">
                                                            <input type="number" id="coef" name="coef" value="<?php echo $p['coef']; ?>" class="form-control" required />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="credit" class="col-md-4 control-label">Crédit *</label>
                                                        <div class="col-md-8">
                                                            <input type="number" id="credit" name="credit" value="<?php echo $p['credit']; ?>"  class="form-control" required />
                                                        </div>
                                                    </div>
                                                    <div>
                                                            <input type="hidden" id="gestion" name="gestion" value="programme"  class="form-control" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=detail_programme&cood=<?php echo $p['id_niveauetude'] ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
