    ...
    <body>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea type="text" id="justification" name="justification" class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="enseignant_remplacer"></div>
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=saveAbsEnseignant",
                  method : "POST",
