...
<head>
        ...
        <title>detail scolarité - GESET</title>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Frais scolarité</li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des payements des frais de scolarité de <b class="text-info"><?php echo $nom_pers.' '.$prenom_pers; ?></b></h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT * FROM payement p, filiere f, niveau_etude n, annee_academique a, frait fr 
                                                        WHERE p.id_filiere = f.id_filiere
                                                        AND p.id_niveauetude = n.id_niveauetude
                                                        AND p.id_annee = a.id_annee
                                                        AND p.id_frais = fr.id_frait
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=editer_scolarite&cood=<?php echo $tablo['id_paye']; ?>" class="btn btn-primary btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a> 
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-header" style ="background-color:rgb(155,40,20); color:white">
                                                              ...
                                                              <h4 class="modal-title" id="myModalLabel"><center>Suppression d'une scolarité</center></h4>
                                                            </div>
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=gestion&action=detail_scolarite&cood=<?php echo $id_etudiant; ?>&parasup=<?php echo $tablo['id_paye'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                  <table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td><b>Frais : </b></td><td><?php echo $tablo['montant']; ?></td>
                                                                                        </tr>
                                                                                    </table><br>
