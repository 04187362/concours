...
<head>
    ...
    <body>
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  if(isset($_GET['cood']) && existanceGestion($table, $colonne, $_GET['cood'])){
                    ...
                    $id_com = addslashes(htmlspecialchars($_GET['cood']));

                    $p = selection_condition($table, $colonne, $id_com);

                    $val_recup = "id_etu";

                    $val_recup2 = "id_matiere";

                    $id_etu = getChampsGestion($val_recup, $table, $colonne, $id_com);

                    $id_matiere = getChampsGestion($val_recup2, $table, $colonne2, $id_com);
                                ...
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=compositionEnseignant2&cood=<?php echo $id_etu; ?>&cood2=<?php echo $id_matiere; ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          // On recupere uniquement les matieres qui sont enseigné par l'enseignant dans la classe selectionnée 
          ...
          // On recupere uniquement les etudiant qui sont inscris dans la classe selectionnée de l'enseignant selectionné
