    ...
    <body>
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Ajout d'une préinscription</legend>
                                            </div>
                                            <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <option value="">Selectionner</option>
                                                                <?php 
                                                                    ...
                                                                    //Conservation lignes par ligne des élements retournés
                                                                    while($tablo=$requete4->fetch()){                      
                                                                    echo  '<option value ="'.$tablo['id_frait'].'">'.$tablo['montant'].' FCFA</option>';
                                                                } ?>     
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=savePreinscription",
                  method : "POST",
