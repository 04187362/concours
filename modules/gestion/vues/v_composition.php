...
<head>
        ...
        <title>Composition - INPTIC</title>
                    ...
                    <?php 
                          ...
                          /*if(isset($_POST['supprimer'])){
                            ...
                            if(isset($_GET['parasup']) && existanceUsers($table, $colonne, $_GET['parasup'])){
                                ...
                                $composer->setEtudiant($id_etudiant);
                              
                                $composer->suppressionMultiLigne();
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman">Liste des compositions</h3>
                            </div>
                            <div class="panel-body">
                                <center>
                                    <a href="index.php?module=gestion&action=saisie_composition" class="btn btn-mint btn-sm text-primary" style ="border-radius:5px; margin-left:10px">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql ="SELECT count(*) as effectif, id_etu, nom_pers, prenom_pers 
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=detail_composition&cood=<?php echo $tablo['id_etu']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=gestion&action=composition1&parasup=<?php echo $tablo['id_etu'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
                                                                    <div class="form-group">
                                                                      <div>
                                                                        <p><b>Attention ! Vous allez supprimer tous les examens et devoirs effectué par </b></p>
                                                                            <p><b><?php echo getChampsUsers($val_recuperer1, $table1, $colonne1, $tablo['id_etu']).' '.getChampsUsers($val_recuperer2, $table1, $colonne1, $tablo['id_etu']); ?> </b></p>
