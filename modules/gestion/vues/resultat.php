                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="text-align:center;font-family:Times New Roman"><b>Resultats des examens</b></h3>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="filiere" class="control-label col-md-4 col-xs-4"> Filière </label>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="semestre" class="control-label col-md-4 col-xs-4"> Semestre </label>
                                                    <div class="col-md-8 col-xs-8">
      ...
      $(document).ready(function(){
         ...
         // On recupere uniquement les niveaux d'etrudes de la filière selectionnée
          ...
          $('#semestre').on('change', function(){
            ...
            var action = "resultat_semestre";
            if(semestre){

              $.post("index.php?module=gestion&action=ajaxResultat",
              {id_niveauetude:id_niveauetude, semestre:semestre, action:action},
                function(data){
                  $('#resultat').html(data);
                }
              );
