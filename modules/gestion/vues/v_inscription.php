                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des etudiants inscrits</b></h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="demo-dt-basic" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                                  $sql ="SELECT * FROM personne p, annee_academique a, frait f
                                                        WHERE p.id_frais = f.id_frait
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $tablo['date_nais_etu']; ?></td>
                                                <td><?php echo $tablo['montant']; ?> FCFA</td>
                                                <td><?php echo $tablo['lib_annee']; ?></td>
                                               ...
                                               <a class="btn btn-primary btn-xs pull-rigth edit_etudiant" id="<?php echo $tablo['id_pers']; ?>" style ="border-radius:5px"><i class="glyphicon glyphicon-pencil"></i></a> 
                                               <a class="btn btn-danger btn-xs" title='Supprimer' data-toggle="modal" data-target=".<?php echo $tablo['id_pers'];?>sbs-example-modal-lg"><i class="glyphicon glyphicon-trash"></i></a>
                                               <a href="index.php?module=gestion&action=imprimer_recu&cood=<?php echo $tablo['id_pers']; ?>" class="btn btn-success btn-xs pull-rigth edit_etudiant" id="<?php echo $tablo['id_pers']; ?>" style ="border-radius:5px"><i class="glyphicon glyphicon-print"></i></a>    
                                                </div> 
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <form  method="POST" action="index.php?module=gestion&action=inscription&parasup=<?php echo $tablo['id_pers'];?>" class="form-horizontal form-label-left input_mask">
                                                                <center>
                                                               ...
                                                               <div class="row">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                      <table>
                                                                        ...
                                                                        <tr>
                                                                          <td style ="padding-right:20px; padding-bottom:10px"><b>Nom :</b></td>
                                                                          <td style ="padding-right:20px; padding-bottom:10px" class="pull-right"><?php echo $tablo['nom_pers'];?></td> 
                                                                        </tr>
                                                                        <tr>
                                                                          <td style ="padding-right:20px; padding-bottom:10px"><b>Prénom :</b></td>
                                                                          <td style ="padding-right:20px; padding-bottom:10px" class="pull-right"><?php echo $tablo['nom_pers'];?></td> 
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr >
                                                                          <td style ="padding-right:20px; padding-bottom:10px"><b>Montant :</b></td>
                                                                          <td style ="padding-right:20px; padding-bottom:10px" class="pull-right">
                                                                            <?php echo $tablo['montant']; ?>
                                                                          </td> 
                                                                        </tr>
