            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <?php
                        ...
                        if(isset($_GET['cood']) && existanceParametrage($table1, $colonne1, $_GET['cood'])){
                          ...
                          // Changement d'etat du paiement
                          updateMultiplePaiement($id_etu);
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title">Historique des paiements de <span class="text-info"><?php echo getChampsUsers($val_recuperer1, $table2, $colonne2, $id_etu).' '.getChampsUsers($val_recuperer2, $table2, $colonne2, $id_etu); ?></span></h3>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="label label-info"><?php echo $tablo['montant']; ?> FCFA</span></td>
                                                <td class="text-center text-danger"><span class="label label-danger"><?php echo $reste; ?> FCFA</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="text-danger"><b class="label label-success"><?php echo $total; ?> FCFA</b></span></td>
                                                <td colspan="2"></td>
                                            </tr>
                                        </tbody>
                                    </table>
