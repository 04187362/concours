...
<head>
        ...
        <title> Affecter absence - GESET</title>
    ...
    <body>
        <div id="container" class="effect mainnav-lg navbar-fixed mainnav-fixed">
            ...
            <header id="navbar">
                ...
                <?php
                  ...
                  $id_em = htmlentities(htmlspecialchars($_GET['cood1']));

                  $requete1 = "SELECT * FROM emargement WHERE id_em=?";
                  $param1 = array($id_em);
                  
                  $requete2 = "SELECT * FROM inscription WHERE id_etu=?";
                  $param2 = array($id_etu);

                  if(isset($_GET['cood']) && isset($_GET['cood1']) && existanceGestion($requete1,$param1) && existanceGestion($requete2,$param2)){

                    // Recuperation du nom et prenom de l'etudiant
                    $requete3 = "SELECT * FROM personne WHERE id_pers=?";
                    $param3 = array($id_etu);

                    $p = selection_condition($requete3,$param3);


                  }else{

                      header("location:index.php?modules=users&action=accueil");
                  }      
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Affecter absence</li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Affecter une absence à <?php echo $p['nom_pers'].' '.$p['prenom_pers']; ?></legend>
                                            </div>
                                            <div class="row">

                                                <div class="col-md-6 col-md-offset-3">
                                                    <input type="hidden" id="emargement" name="emargement" value="<?php echo $id_em ?>" class="form-control" required />
                                                    <input type="hidden" id="etudiant" name="etudiant" value="<?php echo $id_etu ?>" class="form-control" required />
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-md-offset-3" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=absence&cood=<?php echo $id_etu; ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Retour</a>&nbsp                          
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=saveAbsenceEtudiant",
                  method : "POST",
