...
<head>
        ...
        <title> Saisie programme concours</title>
    ...
    <body>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Ajout programme concours</li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Ajout d'un programme du concours</legend>
                                            </div>
                                            <div class="row">
      ...
      $(document).ready(function(){
          ...
          $('#formulaire1').submit(function(){
                ...
                $.ajax({
                  url:"index.php?module=gestion&action=saveProgConcours",
                  method : "POST",
