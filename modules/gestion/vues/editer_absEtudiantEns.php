...
<head>
        ...
        <title> Edition absence etudiant - GESET</title>
            ...
            <div class="boxed">
                ...
                <div id="content-container">
                    ...
                    <div class="pageheader">
                        <h3><i class="fa fa-home"></i> <span style="font-family:Ravie"> Absence </span> </h3>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li> <a href="#"> Accueil </a> </li>
                                <li class="active">Edition d'une absence </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Edition d'une absence</legend>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-md-offset-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            <textarea id="justification" name="justification" class="form-control" /><?php echo $p['justification'] ?></textarea>
                                                        </div>
                                                    </div>

                                                    <div>
                                                            <input type="hidden" id="gestion" name="gestion" value="AbsenceEtudiant"  class="form-control" />
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align:center">
                                                    <a href="index.php?module=gestion&action=listeAbsenceEtudiant" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-list-alt"></i> Afficher</a>&nbsp                          
