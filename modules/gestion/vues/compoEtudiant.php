                            ...
                            <div class="panel-body">
                                <form method="post" id="formulaire1" action="" class="form-horizontal form-bordered">
                                            <div class="form-group">
                                                <legend>Les compositions de <b class="text-primary"><?php echo $nom_personne.' '.$prenom_personne ?></b></legend>
                                            </div>
                                            <div class="row">
                                                
                                                <div  class="col-md-6 col-md-offset-3">
                                                    <input type="hidden" name="etudiant" id="etudiant" value="<?php echo $id_personne; ?>">
                                                    <div class="form-group">
                                                            ...
                                                            <select id="trimestre" name="trimestre" class="form-control"  required>
                                                                <?php 
                                                                    ...
                                                                    if($coun >0){
                                                                        ...
                                                                        echo '<option>Aucune composition n\'a été effectuée.</option>'; 
                                                                    }
