...
<head>
        ...
        <title>Absence enseignant - GESET</title>
                    ...
                    <div class="pageheader">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"> Absence ensignant </li>
                            </ol>
                        </div>
                    </div>
                    <!--Page content-->
                    ...
                    <div id="page-content">
                        ...
                        <div class="panel">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="font-family:Times New Roman"><b>Liste des enseignants absents</b></h3>
                            </div>
                                        ...
                                        <tbody>
                                            <?php
                                                $sql = "SELECT count(*) as effectif, id_ens, nom_pers, prenom_pers 
                                                        FROM absence_enseignant a, personne p 
                                                        WHERE a.id_ens = p.id_pers
                                                        GROUP BY id_ens";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="index.php?module=gestion&action=absenceEnseignant2&cood=<?php echo $tablo['id_ens']; ?>" class="btn btn-warning btn-xs" style ="border-radius:5px"><i class="glyphicon glyphicon-eye-open"></i></a> 
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
